...
#include "RotateActorLeftRight.h"


// Sets default values
ARotateActorLeftRight::ARotateActorLeftRight()
{
...
void ARotateActorLeftRight::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void ARotateActorLeftRight::Tick(float DeltaTime)
{
