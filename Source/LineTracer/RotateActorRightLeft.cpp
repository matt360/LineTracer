...
#include "RotateActorRightLeft.h"


// Sets default values
ARotateActorRightLeft::ARotateActorRightLeft()
{
...
void ARotateActorRightLeft::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void ARotateActorRightLeft::Tick(float DeltaTime)
{
